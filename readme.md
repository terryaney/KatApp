...
mask | For textual inputs, if an input mask should be applied while the user is typing information, a mask pattern can be provided (i.e. `phone`, `zip+4`, `cc-expire`, 'money mask' - see Input and Input Group models for more information).
